/*
 * MISRA C:2012 Rule 10.4 - engineering scaffold
 *
 * Topic: Essential type model
 * Engineering intent: Independent checker contract for Rule 10.4 in the Essential type model family. The exact normative predicate remains linked to the controlled licensed rule specification.
...
class Rule_10_04 final : public Rule {
 public:
...
RulePtr make_rule_10_04() {
  return std::make_unique<Rule_10_04>();
}
