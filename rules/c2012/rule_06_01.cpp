/*
 * MISRA C:2012 Rule 6.1 - engineering scaffold
 *
 * Topic: Types and bit-fields
 * Engineering intent: Independent checker contract for Rule 6.1 in the Types and bit-fields family. The exact normative predicate remains linked to the controlled licensed rule specification.
...
class Rule_06_01 final : public Rule {
 public:
...
RulePtr make_rule_06_01() {
  return std::make_unique<Rule_06_01>();
}
